...
export const MailProvider: Component<{ children: any }> = (props) => {
  ...
  return (
    ...
    >
      {open() && <div modal-backdrop class="bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0" style={{ 'z-index': '9999' }} />}
      <div
        ref={dialogRef}
        tabindex="-1"
        aria-hidden="false"
        ...
        <div class="relative w-full max-w-md max-h-full">
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
              <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Your Personalized Product Picks</h3>
              <form
                class="space-y-6"
                action="#"
                onSubmit={(e) => {
